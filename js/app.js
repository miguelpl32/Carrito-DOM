...
function cargarEventListeners() {
  //agregar curso al hacer click al carrito
  listaCursos.addEventListener("click", agregarCurso);

  //Eliminar curso del carrito
  carrito.addEventListener("click", eliminarCurso);

  //Muestr los curso del Local Storage
...
function eliminarCurso(e) {
  if (e.target.classList.contains("borrar-curso")) {
    ...
    carritoHTML(); // volvemos a iterar sobre el carrito para mostrar el html actualizado
  }
}

//leer el contenido del html y extraer la info del curso
...
function leetDatosCurso(curso) {
  ...
  //Comprueba si un elemento esta en el carrito
